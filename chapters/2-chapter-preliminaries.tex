...
\subsection{Zero-knowledge Proof and Proof of Knowledge Systems}
...
\begin{enumerate}
	...
	This ensures $\widetilde{c}$ and $s_1$ can be correctly computed due to the random linear combination of the sumcheck, while revealing no information about $\widetilde{Q}{r_x}(\cdot)$ as it is masked by the random polynomial $S_Q(\cdot)$ \cite{Aurora2019}\cite{Zhang2019VirgoZK} .
\end{enumerate}
