...
\begin{definition}[Statistically-hiding Commitment]
	...
	\begin{itemize}
		...
		\item \textit{Computationally Binding}: It is impossible for all \gls{ppt} \textit{adversaries} to output commitment that can be opened in two different ways.
	\end{itemize}
\end{definition}
...
%his transparent polynomial commitment scheme is detailed further in Section~\ref{sec:prel_FRI}.
