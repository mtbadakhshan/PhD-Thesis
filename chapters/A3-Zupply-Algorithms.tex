...
%%%%%%%%%%%%%%%%%%%%%%%%%% Divide %%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{algorithm}
	\caption{\textsf{Divide} $\big($\textsc{pp}$, T_{i_1},  \text{PKsig}_{i_{2}}, \text{PKsig}_{i_{3}}, q_{i_{2}}, q_{i_{3}} \big)$ $\rightarrow$ \big($\texttt{tx}_{\textsf{Div}}, \Tilde{T}_{i_{2}}, \Tilde{T}_{i_{3}}, \texttt{Tag}_{i_{2}}, \texttt{Tag}_{i_{3}}\big)$}\label{alg:divide}
	\begin{algorithmic}[1]
		\State {$\texttt{cm}_{i_1} \gets \mathsf{COMM}_{\rho_{i_1}}(\Tilde{T}_{i_1}) $}
