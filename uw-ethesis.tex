...
\usepackage{amsmath,amsthm,amssymb,amstext,mathtools,halloweenmath,bbm} % Lots of math symbols and environments
\usepackage[pdftex]{graphicx} % For including graphics N.B. pdftex graphics driver 
\usepackage{booktabs} 
\usepackage{tabularray, multirow, array, tabularx}
...
\usetikzlibrary{shapes.multipart, positioning, trees}
...
%----------------------------------------------------------------------
% \input{chapters/1-chapter-introduction}
% \input{chapters/2-chapter-preliminaries}
% \input{chapters/3-chapter-literature-review}
% \input{chapters/4-chapter-zupply-framework-design}
% \input{chapters/5-chapter-zupply-framework-security-analysys}
\input{chapters/6-chapter-zupply-framework-implementation}
% \input{chapters/7-chapter-additive-fft-implementation}
% \input{chapters/8-chapter-accelerating-aurora-through-optimizing-additive-FFT}
% \input{chapters/9-chapter-gkr-circuit-design-polaris}
% \input{chapters/10-chapter-conclusions-and-future-works}
